...
export class VoiceRecorderImpl {
    constructor() {
        ...
        this.chunkedBuffer = [];
        this.chunkedInterval = DEFAULT_CHUNK_INTERVAL_MS;
        this.chunkedTimer = null;
        this.chunkIndex = 0;
        this.chunkedEmitter = null;
    ...
    async startChunkedRecording(options) {
        ...
        this.chunkedInterval = (_a = options === null || options === void 0 ? void 0 : options.chunkIntervalMs) !== null && _a !== void 0 ? _a : DEFAULT_CHUNK_INTERVAL_MS;
    ...
    startNewChunkedRecorder() {
        if (this.chunkedStream == null || this.chunkedMimeType == null)
            return;
        this.chunkedBuffer = [];
        this.chunkedRecorder = new MediaRecorder(this.chunkedStream);
        this.chunkedRecorder.ondataavailable = (event) => {
    ...
    scheduleNextChunk() {
        if (this.chunkedRecorder == null || this.chunkedRecorder.state !== 'recording')
            return;
        if (this.chunkedTimer != null)
            clearTimeout(this.chunkedTimer);
    ...
    async rotateChunkAndEmit(isFinalChunk) {
        var _a;
        if (this.chunkedRecorder == null || this.chunkedMimeType == null)
            return;
        ...
        if (blob.size > 0) {
            ...
            (_a = this.chunkedEmitter) === null || _a === void 0 ? void 0 : _a.call(this, chunk);
            this.chunkIndex++;
        }
        if (!isFinalChunk) {
            this.startNewChunkedRecorder();
    ...
    prepareChunkedInstanceForNextOperation() {
        if (this.chunkedTimer != null) {
            clearTimeout(this.chunkedTimer);
            this.chunkedTimer = null;
        }
